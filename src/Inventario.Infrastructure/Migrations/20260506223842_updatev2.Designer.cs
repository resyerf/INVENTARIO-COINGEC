...
namespace Inventario.Infrastructure.Migrations
{
    ...
    [Migration("20260506223842_updatev2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inventario.Domain.Entities.AuthUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Inventario.Domain.Entities.CompraInsumo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Inventario.Domain.Entities.Insumo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Inventario.Domain.Entities.MovimientoInsumo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Inventario.Domain.Entities.SolicitudInsumo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Inventario.Domain.Entities.CompraInsumo", b =>
                {
                    b.HasOne("Inventario.Domain.Entities.Insumo", "Insumo")
                        .WithMany()
